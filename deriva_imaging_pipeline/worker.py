...
class DerivaImagingWorker:
    ...
    def __init__(self, kwargs: dict[str, Any]) -> None:
        ...
        self.processing_dir = kwargs.get('processing_dir')
    ...
    def convert2pyramid(self, filename: str, rid: str) -> int:
        ...
        try:
            ...
            try:
                ...
                os.chdir(currentDirectory)
                self.logger.debug('extract_scenes failed')
                self.logger.error('Can not extract_scenes for file "{}", RID: "{}".\n'.format(filename, rid)) 
                et, ev, tb = sys.exc_info()
